...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { description: @observation.description, lawsuit_id: @observation.lawsuit_id } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { description: @observation.description, lawsuit_id: @observation.lawsuit_id } }
